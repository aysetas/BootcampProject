      ...
      <div class="navbar-wrapper">
        <div class="navbar-header">
          <ul class="nav navbar-nav flex-row">
            ...
            <li class="nav-item"><a class="navbar-brand" href="../../../html/ltr/horizontal-menu-template/index.html"><img class="brand-logo" alt="robust admin logo" src="{{ asset('admin/') }}/app-assets/images/logo/logo-dark-sm.png">
